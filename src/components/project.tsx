...
export default function Project(props: { title: string; description: string; url: string; picture: string }) {
  return (
    <div
      className="bg-gradient-to-b from-zinc-950 to-zinc-800 ml-4 mr-4 sm:ml-0 sm:mr-0 rounded-3xl basis-1/2 border border-zinc-700/80 shadow-lg shadow-zinc-700/20"
      id="projects"
    >
        ...
        <div className="flex flex-row justify-between">
          ...
          <a className="basis-1/4 mt-5 relative" href={props.url}>
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="absolute end-0 bg-gradient-to-b from-zinc-400 to-zinc-700 text-zinc-800 rounded-full p-2 w-14 h-14 transition duration-500 hover:scale-110"
            >
