...
export default function Hero() {
  return (
    <div className="flex flex-row gap-4 mt-4" id="home">
      ...
      <div className="basis-2/5 bg-zinc-900 rounded-3xl p-4 pl-10 pr-10 flex">
        <div className="gap-4 m-auto h-fit">
          ...
          <div className="flex justify-center mt-9">
            <a
              className="text-3xl p-5 pl-10 pr-10 bg-zinc-200 text-zinc-800 shadow-2xl font-medium transition duration-500 hover:bg-zinc-500 hover:text-zinc-200 hover:scale-105 rounded-full"
              href="#"
            >
              Download CV
            </a>
